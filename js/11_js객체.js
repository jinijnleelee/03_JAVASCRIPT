...
//**중요** */
//js객체의 key는 무조건 string(묵시적으로 string)
...
document.getElementById("btn3").addEventListener("click", function () {
    ...
    console.log(std)// JS객체
    console.log(JSON.stringify(std)) // 객체 - >JSON변환
    //**JSON 변환시 객체의 기능은 포함하지 않는다** */
    //-> JSON은 데이터 전달에 특효된 형태
