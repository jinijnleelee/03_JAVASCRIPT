var str = "JS코드는 함수가 아닌 JS 파일 또는 "+
"script태그 내부에 바로 작성하면"
+"HTML 랜더링 시행 시 바로 수행됨";
...
function test() { // test 함수 정의
    ...
    console.log("if문 종료후 num5 :" + num5);
    console.log("if문 종료후 num6 :" + num6);
}

test(); //함수호출 
//console.log("함수외부 num3 :" + num3); // num3 is not defined
//함수 종료 후에는 사용 불가 

// ***script 언어는 중간에 에러가 발생하면 해석을 멈춤***

console.log("함수 외부 num4 : " + num4);
//함수 종료 후에도 사용가능. 전역변수라서.

//var 변수명 중복 확인
var num1 = 999;
console.log("num1의 중복확인 : " + num1)

//자료형 확인(+ 변수 선언 방법)
function typeTest() {
    let temp1 = 100;
    //let temp1 = 200; //변수명 중복X
    //블록 범위 변수 'temp1'을(를) 다시 선언할 수 없습니다.ts(2451)
    ...
    if(true) {
        ...
        const temp3 = 300;
       // temp3 = 400; // 
        //상수형 변수에 값을 할당할 수 없을을 나타내는  error
    }
    console.log(temp1);
   // console.log(temp2); temp2 is not defined
   //console.log(temp2); // erer
   //console.log("temp3"); //dpfj
    //-------------------------------
    //자료형 확인
...
//함수관련 작성하는 경우 => 함수에 작성된  코드 자체가 반환
typeBox.innerHTML += "<br><br>fnSum : " + fnSum + "/ " + typeof fnSum;
// 함수명(메개변수 == 함수호출)(함수 코드가 수행됨)
